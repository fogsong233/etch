...
struct PrintNode {
    ...
    bool operator== (const PrintNode& other) const {
        return content == other.content && std::equal(children.begin(),
                                                      children.end(),
    ...
    constexpr static std::string_view COL = " │ ";
    constexpr static std::string_view ROW = "───";
    constexpr static std::string_view TEE = " ├─";
    constexpr static std::string_view TEE_COL = "─┬─";
    constexpr static std::string_view ELBOW = " └─";
    constexpr static std::string_view SPACE = "   ";
    constexpr static std::string_view REPEAT_WRAP_L = "[";
    constexpr static std::string_view REPEAT_WRAP_R = "]";
    constexpr static unsigned sym_len = 3;

    void print_self(std::ostream& o,
        ...
        while(it != children.end()) {
            ...
            auto nxt_it = std::find_if_not(it, children.end(), [&](auto& other) {
                return (**it) == (*other);
            });
